...
namespace Oxide.Plugins
{
    ...
    public class DeathmatchSoccer : RustPlugin
    {
        ...
        // NOTE: /myemblems and /equipemblem commands are handled by EmblemEditor.cs plugin
        // EmblemEditor provides:
        // - /emblem - Opens web editor link
        // - /myemblems - Shows chat list of saved emblems  
